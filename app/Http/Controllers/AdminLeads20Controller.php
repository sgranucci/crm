...
class AdminLeads20Controller extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $data = [];
        $data['page_title'] = 'Prospectos Asesor';
        $data['url'] = CRUDBooster::adminpath()."/prospect";
