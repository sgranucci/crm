...
class AdminClientesController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        //$this->form[] = ['label'=>'Canal','name'=>'canal_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'canals,name'];
        //$this->form[] = ['label'=>'Producto','name'=>'product_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'products,name'];
        //$this->form[] = ['label'=>'Estado:','name'=>'status_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'lead_statuses,name'];
        ...
        */
        ...
        $ventana21 = Carbon::now()->subDays(21)->format('Y-m-d');
        $ventana20 = Carbon::now()->subDays(20)->format('Y-m-d');
        $ventana10 = Carbon::now()->subDays(10)->format('Y-m-d');
        $this->table_row_color[] = ['condition'=>"[UltTicket] > '$ventana10'  ","color"=>"success"];
        $this->table_row_color[] = ['condition'=>"[UltTicket] >= '$ventana20' and  [UltTicket] < '$ventana10' ","color"=>"warning"];
        $this->table_row_color[] = ['condition'=>"[UltTicket] <= '$ventana21'  ","color"=>"danger"];

        $this->table_row_color[] = ['condition'=>"[situacion_id] == 24 ","color"=>"yellow"];
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $data['url'] = CRUDBooster::adminpath()."/clientes"; 
