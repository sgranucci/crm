<?php namespace App\Http\Controllers;
	...
	class AdminTickets25Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Dia","name"=>"created_at","callback"=>function($row) {
			...
			//	$this->col[] = ["label"=>"Total","name"=>"(select sum(tickets.created_at) from tickets)"];
			...
			$this->form[] = ['label'=>'Canal Id','name'=>'canal_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'canal,id'];
			$this->form[] = ['label'=>'Detalle','name'=>'detalle','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Proxima Accion','name'=>'proxima_accion','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Situacion Id','name'=>'situacion_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'situacion,id'];
			...
			$this->form[] = ['label'=>'Hora Ag','name'=>'hora_ag','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Fecha Ag','name'=>'fecha_ag','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Agenda','name'=>'agenda','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Lead Id","name"=>"lead_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"lead,id"];
			...
			//$this->form[] = ["label"=>"Situacion Id","name"=>"situacion_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"situacion,id"];
			...
			//$this->form[] = ["label"=>"Hora Ag","name"=>"hora_ag","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Fecha Ag","name"=>"fecha_ag","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"Agenda","name"=>"agenda","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
