...
class AdminContactoFacilitadorController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    public function hook_query_index(&$query)
    {
        $query->where('status_id', '=', 2)
                                ->whereIn('proxima_accion', [10,4,11]);
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        // dd($ultimoTicket);
        $data = [];
        $data['page_title'] = 'Contacto Facilitador';
        $data['url'] = CRUDBooster::adminpath()."/contactoFacilitador"; 
